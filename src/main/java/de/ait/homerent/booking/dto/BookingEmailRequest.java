...
@Getter
@Setter
@Schema(description = "Request payload for sending booking confirmation email")
public class BookingEmailRequest {
    ...
    @Schema(description = "Optional confirmation URL for the tenant to confirm booking", example = "http://localhost:8080/api/tenant/bookings/1/confirm")
